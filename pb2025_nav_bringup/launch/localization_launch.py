...
def generate_launch_description():
    ...
    # small_gicp only runs in the livox pipeline (Odin provides map->odom itself).
    load_small_gicp_composable_nodes = LoadComposableNodes(
    ...
    ld.add_action(load_small_gicp_composable_nodes)
